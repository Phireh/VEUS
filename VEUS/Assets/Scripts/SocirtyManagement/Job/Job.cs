...
public class Job
{
    ...
    public Job(TYPE jobType, int quantity, int salary, int start, int finish, float requieredEffortValue,
        int contractedDays, DURATION duration, TIME_DEMAND timeDemand, EXTENSION extension)
    {
        SetInitialValues(jobType, quantity, salary, start, finish, requieredEffortValue,
            contractedDays, duration, timeDemand, extension);
    }

    public Job(TYPE jobType, DURATION duration, TIME_DEMAND timeDemand, EXTENSION extension)
    {
        int quantity;
        int salary;
        int start;
        ...
        int contractedDays, DURATION duration, TIME_DEMAND timeDemand, EXTENSION extension)
    {
        ...
        switch (jobType)
        {
            ...
            case TYPE.CLEANER:
                ...
                break;
            case TYPE.SUBWAY_WORKER:
                n = "trabajador del metro";
                break;
            case TYPE.OFFICE_WORKER:
                n = "trabajador de oficina";
                break;
            case TYPE.EXECUTIVE_OFFICER:
            default:
        ...
        RequieredEffort = new Index("Esfuerzo Necesario", "Esfuerzo necesario para ser " + n, requieredEffortValue);
