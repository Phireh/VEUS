...
public class Citizen
{
    ...
    public Citizen(string name, int money, float healthValue, float happinessValues, PLACE livingPlace, PLACE workingPlace)
    {
        this.name = name;
        Money = money;
    ...
    public static Citizen RandomCitizen(string name)
    {
        ...
        PLACE livingPlace = (PLACE)rand.Next(Enum.GetNames(typeof(PLACE)).Length);
        PLACE workingPlace = (PLACE)rand.Next(Enum.GetNames(typeof(PLACE)).Length);
    ...
    public static Citizen CitizenFromAproximation(string name, ECONOMIC_CLASS economicClass,
        Index.STATE healthState, Index.STATE happinessState, PLACE livingPlace, PLACE workingPlace)
    {
        Random rand = new Random();
        int money;
