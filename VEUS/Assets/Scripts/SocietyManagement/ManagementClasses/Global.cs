...
public class Global
{
    public static class Values
    {
        ...
        public static float[] citizenMoneyExpendingPreferences;
        ...
        public static void InitiallizeCitizens()
        {
            ...
            citizenMoneyExpendingPreferences = new float[Enum.GetNames(typeof(Citizen.MONEY_MANAGEMENT)).Length];
            citizenMoneyExpendingPreferences[(int)Citizen.MONEY_MANAGEMENT.RESPONSIBLE] = 0.15f;
            citizenMoneyExpendingPreferences[(int)Citizen.MONEY_MANAGEMENT.STINGY] = 0.4f;
            citizenMoneyExpendingPreferences[(int)Citizen.MONEY_MANAGEMENT.WASTEFUL] = 0.75f;
    ...
    public class Methods : MonoBehaviour
    {
        ...
        public static void PrintError(string error) => Debug.LogError(error);
        public static void PrintInfo(string error) => Debug.Log(error);
        public static void PrintWarning(string error) => Debug.LogWarning(error);
    ...
    public static class Names
    {
        ...
        public static string[] leisureTypes;
        ...
        public static void Initiallize()
        {
            ...
            cityPart[(int)CityPart.PLACE.CENTER] = "CENTRAL";
            cityPart[(int)CityPart.PLACE.EAST] = "ESTE";
            cityPart[(int)CityPart.PLACE.NORTH] = "NORTE";
            cityPart[(int)CityPart.PLACE.WEST] = "OESTE";
            cityPart[(int)CityPart.PLACE.SOUTH] = "SUR";

            leisurePlaces = new string[Enum.GetNames(typeof(Leisure.PLACE)).Length];
            leisurePlaces[(int)Leisure.PLACE.NONE] = "NINGÚN LADO";
            leisurePlaces[(int)Leisure.PLACE.DISCO] = "DISCOTECA";
            leisurePlaces[(int)Leisure.PLACE.CINEMA] = "CINE";
            leisurePlaces[(int)Leisure.PLACE.PARK] = "PARQUE";
            leisurePlaces[(int)Leisure.PLACE.GYM] = "GIMNASIO";

            leisureTypes = new string[Enum.GetNames(typeof(Leisure.TYPE)).Length];
            leisureTypes[(int)Leisure.TYPE.PARTY] = "FIESTA";
            leisureTypes[(int)Leisure.TYPE.SHOW] = "ESPECTÁCULO";
            leisureTypes[(int)Leisure.TYPE.CALM] = "CALMADO";
            leisureTypes[(int)Leisure.TYPE.SPORT] = "DEPOrtE";

            jobs = new string[Enum.GetNames(typeof(Job.TYPE)).Length];
            jobs[(int)Job.TYPE.NONE] = "NULO";
            jobs[(int)Job.TYPE.POLICEMAN] = "POLICÍA";
            jobs[(int)Job.TYPE.DOCTOR] = "MÉDICO";
            jobs[(int)Job.TYPE.CLEANER] = "LIMPIADOR";
            jobs[(int)Job.TYPE.SUBWAY_WORKER] = "TRABAJADOR DEL METRO";
            jobs[(int)Job.TYPE.OFFICE_WORKER] = "OFICINISTA";
            jobs[(int)Job.TYPE.EXECUTIVE_OFFICER] = "DIRECTOR EJECUTIVO";
        }
    }

    public static void InitiallizeAll()
    {
        Names.Initiallize();
        Values.InitiallizeCitizens();
        Values.InitiallizeJobs();
        Values.InitiallizeLeisures();
        Values.InitiallizeTransports();
    }
