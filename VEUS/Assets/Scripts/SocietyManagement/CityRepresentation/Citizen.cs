...
public class Citizen
{
    ...
    public static int[] economicClassLimitValues = new int[]
    {
        1500,   // LOW
        3500,   // MIDDLE
        10000   // HIGH
    ...
    {
        if (money < economicClassLimitValues[(int)ECONOMIC_CLASS.LOW]) return ECONOMIC_CLASS.LOW;
        else if (money < economicClassLimitValues[(int)ECONOMIC_CLASS.MIDDLE]) return ECONOMIC_CLASS.MIDDLE;
    ...
    public MONEY_MANAGEMENT GetMoneyManagement() => this.moneyManagement;
    public void SetMoneyManagement(MONEY_MANAGEMENT newMoneyManagement) => this.moneyManagement = newMoneyManagement;
    ...
    {
        string res = "_" + ID + "_ => Name: " + name + " | " + "Lives in: " + LivingPlace + "(" + Home.X + ", " + Home.Y + ")" + " | Money: " + money;
        res +=  " | Nature: " + Nature + "| Job: " + acceptedJob.JobType + " | Enviromental Commitment: " + enviromentalCommitment
            + " | Time Managment: " + timeManagement + " | Money Managment: " + moneyManagement;
        res += "\nHealth:\n" + Health + "\nHappiness:\n" + Happiness;
        res += "\nSchedule of Today:\n";
        for (int i = 0; i < 24; i++)
        {
            res += i + ": " + dailySchedule[i] + "   ";
        }
        return res;
    }
