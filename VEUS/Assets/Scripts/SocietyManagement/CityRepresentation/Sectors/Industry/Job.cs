...
public class Job
{
    ...
    {
        string res = "Job: " + JobType + " | Quantity Of Offers: " + Quantity + " | Salary: " + Salary + " | Contract Duration: " + ContractedDays + "\n";
        res += RequieredEffort;
        res += "\nExtension: " + extension + " | Time Demand: " + timeDemand + " | Duration: " + duration;
        res += "\nStart: " + Schedule.Start + " | Time Needed: " + Schedule.RequieredTime;
        return res;
    }
}
